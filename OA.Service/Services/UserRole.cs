...
namespace OA.Service.Services
{
    class UserRole : IUserRole
    {
        ...
        public async Task<IEnumerable<string>> GetAsync(AspNetUser model)
        {
        ...
        public async Task<FeedBack> PostAsync(AspNetUser model, IEnumerable<string> roles)
        {
        ...
        public async Task<FeedBack> DelAsync(AspNetUser model, IEnumerable<string> roles)
        {
