...
namespace OA.Service.Interfaces
{
    public interface IUserAuth
    {
        ...
        /// <param name="accountStatus"></param>
        /// <returns></returns>
        bool AnyByEmailAndAccountStatus(string email, bool accountStatus);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="phoneNumber"></param>
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        Task<string> GeneratePasswordResetTokenAsync(AspNetUser model);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="model"></param>
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        Task<IdentityResult> ResetPasswordAsync(AspNetUser model, string code, string password);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="model"></param>
