...
namespace OA.Service.Interfaces
{
    public interface IUserManage
    {
        ...
        /// <returns></returns>
        Task<List<AspNetUser>> GetAsync(string[] roles);
        /// <summary>
        /// Find by role
        /// </summary>
        /// <param name="role"></param>
        ...
        /// <returns></returns>
        Task<List<AspNetUser>> GetAsync(string role, int skip, int take);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="roles"></param>
        ...
        /// <param name="take"></param>
        /// <returns></returns>
        Task<List<AspNetUser>> GetAsync(string[] roles, int skip, int take);
        /// <summary>
        /// Search By
        /// </summary>
