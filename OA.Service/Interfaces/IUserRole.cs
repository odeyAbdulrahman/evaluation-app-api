...
namespace OA.Service.Interfaces
{
    public interface IUserRole
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<string>> GetAsync(AspNetUser model);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="model"></param>
        ...
        /// <returns></returns>
        Task<FeedBack> PostAsync(AspNetUser model, IEnumerable<string> roles);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="model"></param>
        ...
        /// <param name="roles"></param>
        /// <returns></returns>
        Task<FeedBack> DelAsync(AspNetUser model, IEnumerable<string> roles);
    }
}
