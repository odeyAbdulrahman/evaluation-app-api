...
namespace OA.Api.UnitOfWork
{
    class UnitOfWork : IUnitOfWork
    {
        public UnitOfWork(AppDbContext db, UserManager<AspNetUser> userManager, RoleManager<IdentityRole> roleManager,
         IRepository<Evaluation> evaluationRepository, IRepository<Department> departmentRepository,
        ...
        private IStringCipher stringCipherService;
        public IStringCipher StringCipherService => stringCipherService ??= new StringCipher();
